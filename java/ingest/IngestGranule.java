...
/**
 * This example shows how to ingest a granule into ECHO using the Catalog REST
 * API.
 * 
 * @author jgilman
 */
public class IngestGranule
{
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    ingestGranule(httpClient, token, provider);
  }

  /**
   * Ingests a granule into Catalog REST.
   * 
   * @param httpClient
   ...
   * @throws Exception
   */
  private static void ingestGranule(HttpClient httpClient, String token,
      String provider) throws Exception
  {
    String granuleUr = "GranuleUR100";
    ...
    if (responseCode == 201)
    {
      System.out.println("Granule created.");
    }
    else if (responseCode == 200)
    {
      System.out.println("Granule updated");
    }
    else
    {
